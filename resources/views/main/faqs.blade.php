...
@section('content')
<div id="banner-area">
		<img src="https://d1oktf4gbw23dy.cloudfront.net/banner1.webp" alt="" loading="lazy" />
			...
			<div class="row">
							<div class="col-md-6 col-sm-6">
								...
								<div class="faq-box">
									...
									<p> Although Most projects will be delivered within 2–4 weeks depending on complexity and requirements.</p>
								</div>
								<div class="faq-box">
